...
export default function Home() {
  return (
    <div className="w-screen font-oswald">
      ...
      {/* Section 1 */}
      <div className="bg-laker-purple min-h-[600px] flex justify-center items-center px-4">
        <div className="w-full max-w-[1240px] flex flex-col md:flex-row items-center md:items-start md:justify-between gap-8 md:h-[53%]">
          ...
          <div className="w-full md:w-1/2 text-white flex flex-col justify-center">
            <h1 className="font-bold text-[32px] md:text-[48px] md:w-[538px]">
              ...
              <span className="text-laker-gold">The King</span>
            </h1>
          ...
          <div className="w-full md:w-1/2 flex justify-center md:justify-end">
            <Image
              ...
              width={280}
              height={280}
              className="rounded-full border-4 border-laker-gold drop-shadow-2xl"
            />
          </div>
        </div>
      </div>
      ...
      <div className="bg-white min-h-[580px] px-6 py-20 sm:px-10 md:px-20">
        <div className="max-w-[1280px] mx-auto flex flex-col items-center space-y-18">
          ...
          <div className="flex flex-col items-center gap-6 text-center">
            <h1 className="text-laker-purple font-bold text-3xl sm:text-4xl">
              Why Choose LeCards?
            </h1>
      ...
      {/* Section 3 */}
      <div className="bg-laker-purple flex justify-center px-6 py-20 sm:py-24">
      ...
      {/* Section 4 */}
      <div className="bg-laker-gold min-h-[232px] sm:px-10 text-laker-purple flex justify-items-center">
            ...
            <div className="bg-[#F0F0F0] rounded-xl flex flex-col p-6 sm:p-8 text-left gap-4 min-h-[220px]">
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col -mt-1">
                  <h3 className="text-laker-purple text-lg sm:text-2xl font-bold">
                    Bronny James
                  </h3>
      ...
      {/* Section 6 */}
      <div className="bg-laker-purple flex justify-center items-center px-6 py-16 sm:py-20">
